...
namespace PhotoContest.Tests.ServicesTests.ReviewServiceTests
{
    ...
    {
        [TestMethod]
        public async Task Create_Review_Successfully()
        {
            var options = Utils.GetOptions(nameof(Create_Review_Successfully));
        ...
        [TestMethod]
        public async Task Throw_When_CommentIsNotValid()
        {
            var options = Utils.GetOptions(nameof(Throw_When_CommentIsNotValid));
            var userStore = new Mock<IUserStore<User>>();
            var userManager = new Mock<UserManager<User>>(userStore.Object, null, null, null,
                null, null, null, null, null);
            var contextAccessor = new Mock<IHttpContextAccessor>();
        ...
        [TestMethod]
        public async Task Throw_When_UserIsNotInJury()
        {
            var options = Utils.GetOptions(nameof(Throw_When_UserIsNotInJury));
            var userStore = new Mock<IUserStore<User>>();
            var userManager = new Mock<UserManager<User>>(userStore.Object, null, null, null,
                null, null, null, null, null);
            var contextAccessor = new Mock<IHttpContextAccessor>();
        ...
        [TestMethod]
        public async Task Throw_When_PhotoIsAlreadyReviewed()
        {
            var options = Utils.GetOptions(nameof(Throw_When_PhotoIsAlreadyReviewed));
            var userStore = new Mock<IUserStore<User>>();
            var userManager = new Mock<UserManager<User>>(userStore.Object, null, null, null,
                null, null, null, null, null);
            var contextAccessor = new Mock<IHttpContextAccessor>();
