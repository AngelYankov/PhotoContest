...
{
    [TestClass]
    public class GetAllWithCommentsAndScore_Should
    {
        [TestMethod]
        ...
        [TestMethod]
        public async Task Throw_When_UserIsNotInContest()
        {
            var options = Utils.GetOptions(nameof(Throw_When_UserIsNotInContest));
